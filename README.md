...
1. Clone this repository, then run `pnpm install` in its root directory.

2. For the starter to have full functionality locally (e.g. edge functions, blob store), install dependencies and use the local Netlify CLI provided by the project.
